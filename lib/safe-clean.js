...
const { assertSafeChild } = require('./path-guard');
 ...
 */
function safeCleanDir(dir, options = {}) {
  if (!dir || typeof dir !== 'string') return;
  if (!options.allowedRoot) throw new Error('safeCleanDir 必须声明 allowedRoot');
  dir = assertSafeChild(options.allowedRoot, dir, '清理目录');
