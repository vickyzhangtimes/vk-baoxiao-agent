...
**维护者 / 发布者**：Vicky（AI 营销咨询 OPC）

本项目是基于上游开源 skill **「先锋级智能体 skills_BT-7274」**（原作者 【aigc猎手竹相左边】）的二次开发版本，遵循 MIT 协议。感谢原作者的设计与基础实现。

- 上游原始版权声明见 `LICENSE`。
- 本仓库的衍生改动：新增图片 intake 模式、报销单模板化渲染、step4 金额/税额计算修复、致命错误分级退出等，详见 `CHANGELOG.md`。
